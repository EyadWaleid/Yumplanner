...
public class AreaCountryMapper {
    ...
    static {
        ...
        AREA_TO_COUNTRY_CODE.put("Australian", "au");
        ...
        AREA_TO_COUNTRY_CODE.put("Norwegian", "no");
        AREA_TO_COUNTRY_CODE.put("Polish", "pl");
        AREA_TO_COUNTRY_CODE.put("Portuguese", "pt");
        AREA_TO_COUNTRY_CODE.put("Russian", "ru");
        AREA_TO_COUNTRY_CODE.put("Saudi Arabian", "sa");
        AREA_TO_COUNTRY_CODE.put("Slovakian", "sk");
        AREA_TO_COUNTRY_CODE.put("Spanish", "es");
        AREA_TO_COUNTRY_CODE.put("Syrian", "sy");
